    ...
    <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="navBarOptions">
        ...
        <li class="nav-item dropdown grid-elements">
            ...
            <ul class="dropdown-menu navbar-dropdown" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item nav-link nav-menu-links dropdown-menu-links" href="#about/overview" id="aboutConfluence">Learn about Pals</a></li>
        ...
        <li class="nav-item dropdown grid-elements">
            ...
            <ul class="dropdown-menu navbar-dropdown" aria-labelledby="navbarDropdown">
                ...
                ${
                    ...
                    ``:
                    `
                        <li><a class="dropdown-item nav-link nav-menu-links dropdown-menu-links pl-4" href="#data_exploration/subset" title="Subset Statistics" id="dataSummarySubset">
                            Subset Statistics
                        </a></li>
                    `
                }
        ...
        `<li class="nav-item dropdown grid-elements">
            ...
            <ul class="dropdown-menu navbar-dropdown" aria-labelledby="navbarDropdown">
                ${
                    authChair ? (
                        `<li><a class="dropdown-item nav-link nav-menu-links dropdown-menu-links" href="#chair_menu" title="Chair Menu" id="chairMenu"> DACC Chair Menu </a></li>`
                    ) :''
                }
                ${
                    authAdmin ? (
                        `<li><a class="dropdown-item nav-link nav-menu-links dropdown-menu-links" href="#auth_table" title="Admin Table" id="authTable"> Admin Table </a></li>`
                    ) :''
                }
    ...
    <ul class="navbar-nav ml-auto" id="navBarOptions2">
            ${localStorage.parms && JSON.parse(localStorage.parms).name ? `
                <li class="nav-item dropdown grid-elements d-flex">
                    ...
                    <ul class="dropdown-menu navbar-dropdown" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item nav-link nav-menu-links dropdown-menu-links" href="#logout" id="logOutBtn">Log Out</a></li>
                    </ul>
                </li>
            ` : `
                <li class="grid-elements">
