    ...
    template += `
        <div class="secondary-bg padding-bottom-1rem">
            <div class="confluence-banner">
                <img src="./static/images/Picture7.jpg" class="banner-logo" alt="Pals background">
                <div class="banner-overlay-text row justify-content-center text-center">
                    <div class="col-xl-12">
                        <h1 class="banner-overlay-h1">Pals DATA PLATFORM</h1>
            ...
            <div class="container align-middle text-center" style="margin-top: 70px;">
                <div class="row" id="infoDeck" style="min-height: 200px;">`
                    template += cardContents({header: 'Learn about Pals', button: 'Learn about Pals', href: '#about/overview', icon: 'fa-download', explanation: 'Learn about the aims of Pals'})
        ...
        <div class="container align-center">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 font-size-18 align-left">Insert a brief description of Pals Goals</div>
                <div class="col-lg-3"></div>
            </div>
            <br>
            <div class="row">
        ...
        <div class="ternary-bg">
            <div class="container align-left confluence-info font-family-helvetica">
                <div>Pals was developed by National Cancer Institute (NCI) investigators in the Division of Cancer Epidemiology and Genetics and the Division of Cancer Control and Population Sciences.</div>
            </div>
        </div>
    `
