    ...
    let template = `
        <div class="main-summary-row">
            <div class="align-left">
                <h1 class="page-header">Learn about Pals</h1>
            </div>
        </div>
        <div class="home-page-stats font-size-18 ps-2 pe-2">
            <div class="main-summary-row black-font">
                <div class="col align-left pt-2">
                    <div class="mb-3">
                        View Pals’s Home Page, including a description of the Pals recall system, a link to the Researcher Site to access the tool, and selected Pals publications.
                    </div>
                    <div class="mb-3">
                        <a href="https://dceg.cancer.gov/research/what-we-study/physical-activity" target="_blank" rel="noopener noreferrer">Pals Home Link</a>
                    </div>
                </div>
            </div>
        </div>
